...
('John', 'Smith', '123-456-7890', 'john@example.com', '123 Elm St'),
('Jane', 'Doe', '234-567-8901', 'jane@example.com', '456 Oak St'),
('Alice', 'Brown', '345-678-9012', 'alice@example.com', '789 Pine St'),
('Bob', 'White', '456-789-0123', 'bob@example.com', '101 Maple St'),
('Carol', 'Black', '567-890-1234', 'carol@example.com', '202 Birch St');
